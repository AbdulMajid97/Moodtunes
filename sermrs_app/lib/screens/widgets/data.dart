...
class Data {
  var playlist = [
    ...
    {
      'name': 'Where the Light Is: John Mayer',
    ...
    {
      'name': 'This is Eric Clapton',
      'image': 'assets/images/ericclapton.png',
    },
    {
      'name': 'This is The Bealtes',
  ...
  var anotherRandomList = [
    ...
    {
      'name': 'Harry James, Frank Sinatra',
      'image': 'assets/images/franksinatra.png',
      'shape': GFAvatarShape.square,
      'alignment': CrossAxisAlignment.start,
    },
    {
      'name': 'This is Eric Clapton. The essential tracks.',
      'image': 'assets/images/ericclapton.png',
      'shape': GFAvatarShape.square,
      'alignment': CrossAxisAlignment.start,
    },
